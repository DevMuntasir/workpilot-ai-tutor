...
function AppQrCode() {
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_16px_45px_rgba(15,23,42,.08)]">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.05fr_.95fr] lg:gap-20">
        ...
        >
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
            <Link
              href="/signup"
              className="group inline-flex items-center justify-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition hover:-translate-y-0.5"
            >
              Start learning free
        ...
        <div className="relative mx-auto flex min-h-[650px] w-full max-w-[500px] items-center justify-center">
          <div className="absolute h-[420px] w-[420px] rounded-full border border-primary/10 bg-gradient-to-br from-primary/[0.08] to-cyan-100/40" />
          <div className="absolute h-[330px] w-[330px] rounded-full border border-primary/10" />
          <PhonePreview />
        </div>
      </div>
    </section>
